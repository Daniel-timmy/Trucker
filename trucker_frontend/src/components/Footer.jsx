        ...
        <Container fluid className="footer-section"
            ...
            <Row className="justify-content-md-center">
                <Col className="footer-logo">
                    <h1>Trucker</h1>
                    <div className="footer-socials-icons me-auto, justify-content-start" style={{ display:"flex", gap: "9px" }}>
                ...
                <Col className="footer-links">
                    <div className="footer-links-container">
                        <ul className="footer-links-list" style={{ listStyleType: 'none', padding: 0, fontSize: '1.2rem' }}>
                            <li>About Us</li>
                            <li>Blog</li>
                        </ul>
                        </div>
