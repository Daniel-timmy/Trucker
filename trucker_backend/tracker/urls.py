...
from .views import (RegisterView, TripView, TripModifyView, DriverModifyView,
                     LogSheetListCreateView, LogSheetModifyView, TripLogEntriesView, TripPatchView,
...
urlpatterns = [
    ...
    path('trips/<str:id>/refuel/', TripPatchView.as_view(), name='refuel_trip'), # Refuel trip
    ...
    path('logentries/<str:id>/trips/', TripLogEntriesView.as_view(), name="trip_logentries"),
